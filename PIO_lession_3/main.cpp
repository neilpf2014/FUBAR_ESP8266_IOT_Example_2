/*
  WS2812 led Example code
  This will demo how to control LED with commands over serial
  Need to use PIO library manager to get the Fastled library proir to compile
*/
