...
int readAPInt(void)
{
    ...
    // read from serial
		...
		{
			Ch = Serial.read();
			Serial.print(Ch); // echo to console
      // will ignore any non numeric char
      // converts numeric into a integer
...
// toggle onboard LED on/off, returns led on/off state
